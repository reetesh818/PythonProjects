...
def hangman():
    ...
    lives = 6 #to limit the number of guesses by a particular user
    ...
    if lives == 0:
            print('OOPS!Sorry, You are Dead! The correct word was:',word)
    else:
            print("Congratulations! You guessd the right word:",word)
